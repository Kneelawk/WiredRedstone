...
sealed class GateXnorBlockNode : AbstractGateBlockNode<GateXnorPart>(GateXnorPart::class) {
    ...
    data class Input(private val side: Direction, private val inputType: AbstractTwoInputGatePart.InputType) :
        ...
        override fun getConnectDirection(part: GateXnorPart) = part.getInputSide(inputType)
    ...
    data class Output(private val side: Direction) : GateXnorBlockNode() {
        override val type = Type.OUTPUT

        override fun getSide() = side

        override fun getConnectDirection(part: GateXnorPart) = part.getOutputSide()
