...
object WRPartRenderers {
    ...
    fun init() {
        ...
        register(StandingBundledCablePartBaker, StandingBundledCablePartKey::class)
        ...
        register(GateXnorPartBaker, GateXnorPartKey::class)
        register(GateXorPartBaker, GateXorPartKey::class)
