...
data class RedAlloyWirePartExt(private val side: Direction) : SidedWireBlockNode, RedstoneCarrierPartExt {
    override val redstoneType = RedstoneWireType.RedAlloy

    override fun getSide(): Direction = side
    override fun getTypeId(): Identifier = WRPartExts.RED_ALLOY_WIRE_ID
