...
data class InsulatedWirePartExt(private val side: Direction, val color: DyeColor) : SidedWireBlockNode,
    RedstoneCarrierPartExt {

    override val redstoneType = RedstoneWireType.Colored(color)

    override fun getSide(): Direction = side
    override fun getTypeId(): Identifier = WRPartExts.INSULATED_WIRE_ID
