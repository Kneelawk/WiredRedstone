...
abstract class AbstractWRPart(definition: PartDefinition, holder: MultipartHolder) : AbstractPart(definition, holder), BlockNodeContainer, WRPart {
    ...
    protected open fun updateConnections(world: ServerWorld) {
        GraphLib.getController(world).updateConnections(getPos())
    }
